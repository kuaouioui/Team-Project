			...
			<form action="edit_profile.php" method="post">
				...
				<div class="center">
					<table style="width:600px;">
						...
						<tr>
							<td>
								<label for="password">Password<span class="small">(6 characters min.)</label>
							</td>
							<td>
						...
						<tr>
							<td>
								<label for="passverif">Password<span class="small">(verification)</label>
							</td>
							<td>
								<input type="password" name="passverif" id="passverif" value="<?php echo $password; ?>" />
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<label for="avatar">Avatar<span class="small">(optional)</label>
							</td>
							<td>
